...
export const DefaultBondStrategyAbi = [
  {
    inputs: [
      ...
      {
        internalType: 'contract IERC20TvlModule',
        name: 'erc20TvlModule_',
        type: 'address',
      },
      {
        internalType: 'contract IDefaultBondModule',
        name: 'bondModule_',
        type: 'address',
      },
    ],
  ...
  { inputs: [], name: 'InvalidBond', type: 'error' },
  { inputs: [], name: 'InvalidCumulativeRatio', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
    ...
    name: 'DefaultBondStrategyProcessWithdrawals',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      ...
      {
        components: [
          { internalType: 'address', name: 'bond', type: 'address' },
          { internalType: 'uint256', name: 'ratioX96', type: 'uint256' },
        ],
        indexed: false,
        internalType: 'struct IDefaultBondStrategy.Data[]',
        name: 'data',
        type: 'tuple[]',
      },
      {
    ...
    name: 'DefaultBondStrategySetData',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: 'erc20TvlModule',
    outputs: [
      { internalType: 'contract IERC20TvlModule', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
if (!process.env.DEFAULT_BOND_STRATEGY_ADDRESS) {
  throw new Error('No DEFAULT_BOND_STRATEGY_ADDRESS in ENV')
}
