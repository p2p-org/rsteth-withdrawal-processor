...
export const VaultAbi = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint128[]', name: 'ratiosX96', type: 'uint128[]' },
          {
            internalType: 'uint256[]',
            name: 'erc20Balances',
            type: 'uint256[]',
          ...
          { internalType: 'uint256', name: 'ratiosX96Value', type: 'uint256' },
          { internalType: 'uint256', name: 'timestamp', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'bool', name: 'isUnderlying', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: 'minAmounts', type: 'uint256[]' },
      { internalType: 'uint256', name: 'deadline', type: 'uint256' },
      { internalType: 'uint256', name: 'requestDeadline', type: 'uint256' },
...
if (!process.env.RSTETH_VAULT_CONTRACT_ADDRESS) {
  throw new Error('No RSTETH_VAULT_CONTRACT_ADDRESS in ENV')
}
